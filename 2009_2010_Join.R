...
df_full <- merge(x = df_full, y = cbq_09_10, by = "SEQN", all = TRUE)
df_full <- merge(x = df_full, y = cbq_adult_09_10, by = "SEQN", all = TRUE)
df_full <- merge(x = df_full, y = cbq_child_09_10, by = "SEQN", all = TRUE)
