...
#Put demographics and gender in base model, potentially interactions
...
#ggplot(aes(x = DIQ010, y = BMXBMI),) + geom_histogram()
...
#CreateTableOne(data = selected_df, variables = , strata = )
```
