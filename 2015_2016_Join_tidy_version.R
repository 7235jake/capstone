...
tables = c("DIQ_I", "HDL_I", "TRIGLY_I", "TCHOL_I", "GLU_I", "HSQ_I", "DBQ_I", "MCQ_I", "PAQ_I", "PFQ_I", "WHQ_I", "BMX_I", "BQP_I", "DEMO_I")
...
# Same as above but tidyish

nhanesRaw = map(tables, nhanes)
joinedData = reduce(nhanesRaw, left_join, by = "SEQN")
